---
title: "Review files in a directory"
output: 
  html_document:
    toc: false
...
d <- fs::dir_ls(here::here("directories", "obs_2022-03-15"))

d <- stringr::str_replace_all(
  d, "C:/Users/Crystal/Desktop/desktop/R/Working R Stuff/", "")

stringr::str_replace_all(
  d, "data-wrangling-functions", "/project")
...
base::basename(dir_ls(here::here("directories", "obs_2022-03-15")))
...
base::list.files(here::here("directories", "obs_2022-03-15"))
