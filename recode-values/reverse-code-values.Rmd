...
* Note: In this scenario we are writing over the existing variables and then renaming them. You could also keep both the new and old variables like I do in the second scenario below. 
