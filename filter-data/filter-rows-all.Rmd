...
**1\. Filter out any row that has -999 for *AT LEAST ONE* variable.**
...
**2\. Filter out any row that has -999 for *ALL* variables.**
...
**3\. Keep rows where any variable that starts with the word "item" contains the value "MR".**
...
**3\. Return rows "form" is NOT empty, and var1:var ARE empty.**
...
You can see that this data has some funky things going on (a mixture of empty character values as well as NA values).
