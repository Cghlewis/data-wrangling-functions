...
* Note: In the case of a character variable, the levels will be chosen based on the order in which they appear. In the case of a numeric variable, the levels will be numerically ordered.
...
* Note: The levels will be chosen alphabetically or numerically.
