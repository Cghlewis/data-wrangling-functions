...
d <- dir(path = here::here("import-data", "attendance"), pattern=".xlsx", full.names=TRUE) %>%
  map_dfr(readxl::read_excel, na="*", .id = "file")
...
**3\. Add the full file name to differentiate which rows came from which files by adding the function `purrr::set_names()` as well as the argument *".id"* and have it equal to whatever you want that new variable to be called.**
