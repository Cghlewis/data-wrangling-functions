...
**1\. Replace (sr) and sr. with "senior"**
...
**2\. Replace all instances of the word "and" from item1 with "or"**
...
Notice here, if we simply use `stringr::str_replace()` we will only remove the first instance of "and".
...
So therefore, if we want to remove all instances, we need to use `stringr::str_replace_all()`
