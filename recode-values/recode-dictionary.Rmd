---
title: "Recode using a dictionary"
output: 
  html_document:
...
1. There may be times when you would rather recode open-ended gender responses based on an existing dictionary (and their misspelling variations). In this case, you can use an existing package that has a dictionary built in. In this example, we will recode gender using the `gendercoder` package.
