...
* Note: Renaming here is done using the `dplyr::rename_with()` function as well as `base::paste0()`. `dplyr::rename_with()` allows you to rename columns using a function.
