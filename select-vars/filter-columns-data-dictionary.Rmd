...
Oftentimes we develop a data dictionary to include everything that exists in our raw data. It is reasonable to include a column that describes what you plan to do with a column, such as drop a column.
...
* Note: We use `dplyr::pul()` to extract the one column with the names of the variables in our data dictionary and create a character vector
