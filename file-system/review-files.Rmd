...
* Note: There are more columns you can view with this function but I have selected 3 columns of interest to view here.
...
**2\. Find the most recent version of a file**

In this scenario, I want to find the most recent version of my file based on the modification time of a file.
...
However, I don't always trust the modification time to give me my most recent version.You'll notice that I've also versioned our files by adding "_v#" as a suffix to each file name. I can instead use this information to find the most recent version.
