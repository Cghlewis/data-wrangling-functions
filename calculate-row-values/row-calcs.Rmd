...
* Note: The default for `base::sum()` is to not calculate a sum if any NA value exists in your columns. If you want to still calculate a sum despite missing values, you can set the argument to *na.rm = TRUE*.
...
* Note: To learn more about how base R does rounding, see [Rounding](https://github.com/Cghlewis/data-wrangling-functions/wiki/Rounding).
