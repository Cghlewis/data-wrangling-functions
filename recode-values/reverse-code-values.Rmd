...
* Note: Again I wrote this all into a new dataset because this syntax, using `dplyr::mutate_at()`, writes over our existing Var2 and Var3 and in this scenario I wanted to keep the old variables.

* Note: Renaming here is done using the `dplyr::rename_at()` function as well as `base::paste0()`.
