...
**2\. Split only some of the cells in a column (school_name) and keep only one column of the split**
...
d6 %>% tidyr::separate(school_name, "[A-Z]\\.\\s", into = c("name1", "school_name"), fill="left") %>%
  dplyr::select (-name1)
