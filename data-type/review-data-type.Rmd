...
You could also view the class for each variable using a function like `base::lapply()` or `base::sapply()` to iterate the `base::class()` function over each variable
