...
Again, you could get the same result adding the `stringr::str_detect()` function and either adding the *!* operator or adding the `stringr::str_detect` argument *negate=TRUE* which returns non-matching elements.
...
**1\.Conditionally filter grade levels based on school name. Filter to grades between 1 & 2 for school a and grade=9 for school b**
