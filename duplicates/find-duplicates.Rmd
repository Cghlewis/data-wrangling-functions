...
In the case of the data above, I only expect to have one row per student id. It appears one student completed the survey twice. 
...
We can see in our new data, we have several instances of duplicate data.
In this new scenario, my new decision rule for keeping duplicates is to keep the **most *recent**, **complete** data.
...
IDs 103, 105 and 100 all have the most complete, most recently completed surveys at the top.
