...
* Note: `knitr::kable()` function used to make output more readable but we lose the value labels. If you run the `labelled::look_for()` function without adding `knitr::kable()` or `dplyr::select()` you will see the value labels.
