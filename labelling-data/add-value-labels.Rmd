...
* Note: Quotes are *not* required around labels here but I am using them around multi-word labels with spaces. Also using them around all labels will not hurt anything.
...
* Note: Quotes are *not* required around labels here, although adding them will not hurt.
