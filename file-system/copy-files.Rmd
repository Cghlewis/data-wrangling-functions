...
First let's view how many folders named "obs_YYYY-MM-DD" that we have. We will need to change our directory to be a level higher than in the previous example (up to the "file-system" folder). 
