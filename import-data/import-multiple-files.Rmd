...
* Note: `purrr::map_dfr()` combines tibbles (data frames) by stacking them on top of each other. The main arguments you include are *.x*, a list or atomic vector (files to read), and *.f*, which in this scenario is a function.
