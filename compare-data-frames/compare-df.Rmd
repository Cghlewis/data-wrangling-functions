...
In this scenario we find that the files are identical. Awesome! We can simply choose one to work with and archive the other.  However, what would the output look like if they were not identical.
...
We find out that the files are **not** identical! Student ID is now a character variable rather than numeric. We would need to make a decision regarding which file to use.
