...
* Note: I use `dplyr::across()` to select multiple values to apply my function to.
...
* .x is used to say, if any of the variables I have selected contain (%in%) the values of "MR" or "UI".
