...
Last, if we only cared about certain variables in our data frames, we could add a `dplyr::select()` statement in a `purrr::map()` function to select our variables from our list of data frames before creating our environment variables.
