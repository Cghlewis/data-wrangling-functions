...
* Note: Your new form does not need to have all of the same variables as your original form. It will only update the variables that match across both forms. It CANNOT however, have MORE variables than the original form. This will cause an error.
